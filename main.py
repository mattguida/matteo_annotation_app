...
def load_session_data():
    """Load all sentences from annotation_session_3.jsonl"""
    file_path = os.path.join(BASE_DIR, "templates", "data", "annotation_session_3.jsonl")
    try:
...
def create_annotator_dataset(annotator_id, annotator_name):
    ...
    if not session_data:
        return None, "Could not load sentences from annotation_session_3.jsonl"
...
def get_system_info():
    ...
    try:
        ...
        return {
            ...
            "sentences_per_annotator": len(session_data),
            "source_file": "annotation_session_3.jsonl"
        }
